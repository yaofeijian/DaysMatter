...
open class DatePickerDialog: UIView {
    ...
    private var rightButtonColor:UIColor!
    private var font: UIFont!

    // MARK: - Dialog initialization
    @objc public init(leftButtonColor: UIColor = UIColor.blue,
                rightButtonColor: UIColor = UIColor.blue,
                font: UIFont = .boldSystemFont(ofSize: 15),
                locale: Locale? = Locale.init(identifier: "Chinese"),
...
//        container.layer.shadowOpacity = 0.1
        ...
        //Title
        self.titleLabel = UILabel(frame: CGRect(x: 0, y: 0, width: dialogSize.width, height: 44))
        titleLabel.backgroundColor = .backgroundGray
    ...
    fileprivate func configuredDatePicker() -> UIDatePicker {
        let datePicker = UIDatePicker(frame: CGRect(x: 0, y: 44, width: 0, height: 0))
        ...
        datePicker.frame.size.height = 202
        return datePicker
    }
    ...
    private func addButtonsToView(container: UIView) {
        ...
        if showCancelButton {
            ...
            self.cancelButton.setTitleColor(self.leftButtonColor, for: .normal)
            self.cancelButton.setTitleColor(self.leftButtonColor, for: .highlighted)
            self.cancelButton.titleLabel?.font = self.font.withSize(18)
        ...
        self.doneButton.setTitleColor(self.rightButtonColor, for: .normal)
        self.doneButton.setTitleColor(self.rightButtonColor, for: .highlighted)
        self.doneButton.titleLabel?.font = self.font.withSize(18)
